...
const publicPassport = (p) => p && { ...p, launchpad: p.launchpad || Origins.recordOrigin(p), recordHash: Market.hashJson({ token: p.token, operator: p.operator, history: p.history }) };
